...
map.getView().fit([11970370.949187, -767692.575106, 11972387.504370, -766238.010711], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Lokasi Masjid di Kota Cimahi </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (43 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '8 Lokasi Masjid yang berada di Kota Cimahi ';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_8MasjiddiKotaCimahi_1,
    colName: 'Deskripsi',
    zoom: 10,
    collapsed: true,
    map: map
